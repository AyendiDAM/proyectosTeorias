<%-- 
    Document   : tablaAnalista
    Created on : 2 dic 2025, 9:44:37
    Author     : ayend
--%>
...
<body>
<header>
<div class="brand">Panel de analista</div>
...
<nav>
    <a href="VerPartidosCantidad.jsp">Ver el n&uacute;mero de partidos</a><br>
       <a href="verCandidatosLocalidad.jsp">Ver candidatos</a><br>
              <a href="crearCookieAnalista.jsp">Crear cookie</a><br>
...
<article class="election-card">
        <form action="../NumeroPartidosControlador" method="POST">

    
<button type="submit" class="btn primary">comprobar numero de partidos</button>
