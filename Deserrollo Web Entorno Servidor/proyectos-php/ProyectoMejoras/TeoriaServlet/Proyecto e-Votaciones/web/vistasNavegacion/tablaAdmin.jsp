...
<%
    ...
    Cookie []lasCookies=request.getCookies();
        ...
        if (lasCookies!=null) {
    //buscamos cookies
    for (Cookie lasCookiesTemporal : lasCookies) {
   if("usuario.login".equalsIgnoreCase(lasCookiesTemporal.getName())){
       nombreCoo=lasCookiesTemporal.getValue();
    ...
    <body>
        ...
        <aside>
            ...
            <nav>
                ...
                <a href="vistasNavegacion/gestionElecciones.jsp">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                    Elecciones
                </a>
                <a href="vistasNavegacion/gestionPartido.jsp">
                ...
                <a href="vistasNavegacion/gestionCandidatos.jsp">
            ...
            <div class="admin-info">
                ...
                <a href="../home.jsp" title="Salir" style="color: #ef4444;">
        ...
        <main>
            <header>
                <div>
                    ...
                    <span class="subtitle">Bienvenido al panel de gestión del sistema e-Votaciones.<%=nombreCoo%></span>
                </div>
            ...
            <section class="mgmt-grid">
                ...
                <a href="vistasNavegacion/gestionElecciones.jsp" class="action-card">
                    <div>
                ...
                <a href="vistasNavegacion/gestionPartido.jsp" class="action-card">
                    <div>
                ...
                <a href="vistasNavegacion/gestionCandidatos.jsp" class="action-card">
                    <div>
                ...
                <a href="vistasNavegacion/resultados.jsp" class="action-card">
                    <div>
