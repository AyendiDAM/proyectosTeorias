 ...
 * @author ayend
 */
public class AbrirEleccionServlet extends HttpServlet {
    ...
    HttpSession miSesion=request.getSession(true);
            /* TODO output your page here. You may use following sample code. */
                        String nombre = request.getParameter("nombreEleccion");
          //  String nombreNuevo = request.getParameter("eleccion");
        ...
        int idEleccion=bbdd.eleccionId(nombre);
        //String estadoEleccion=  bbdd.updateEleccionAdmin(nombre, nombreNuevo);
          miSesion.setAttribute("idEleccion", idEleccion);
