 ...
 * @author ayend
 */
public class GestionModificarEleccionServlet extends HttpServlet {//modificar elecciones
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (dao.actualizarEstado(id, nuevoEstado)) {
                    String mensaje = "";
                    if (nuevoEstado.equals("ABIERTA")) {
                        mensaje = "¡Escrutinio Abierto! Los usuarios pueden votar.";
                    } else {
                        mensaje = "Elección Finalizada. Resultados disponibles.";
                    }
