...
public class GestionCandidatoServlet extends HttpServlet {
    ...
    HttpSession miSesion=request.getSession(true);
            ...
            String numLista = request.getParameter("numLista");
            String idPartido2 = request.getParameter("idPartido");
            
            int numP=Integer.parseInt(numLista);
            int idPartido=Integer.parseInt(idPartido2);
           
           
         
                    try {
        ConexionBBDD bbdd = new ConexionBBDD();
        int tipoUsuario=bbdd.insertarCandidato(nombre, apellidos, numP, idPartido);
             //
            bbdd.cerrarConexion();
