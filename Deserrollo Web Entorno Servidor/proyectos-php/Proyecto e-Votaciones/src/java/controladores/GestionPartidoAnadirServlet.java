...
public class GestionPartidoAnadirServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String logo = request.getParameter("partidoSeleccionado");
           
         
            Partido_politico partidoPolitico=new Partido_politico(nombre, siglas, logo);
                    try {
        ConexionBBDD bbdd = new ConexionBBDD();
        int tipoUsuario=bbdd.partidoPolitico(nombre, siglas,logo);
             //
            bbdd.cerrarConexion();
            
   miSesion.setAttribute("PartidoCreado", "Partido creado correctamente");
